...
export const DEFAULT_CONTACT_PAGE_DATA: ContactPageData = {
  ...
  sections: {
    hero: {
      ...
      mode: "buttons",
      buttons: [
        { label: "Call Us", href: "tel:+61450009291", style: "gold", open_in_new_tab: false },
        { label: "Email Us", href: "mailto:admin@realgoldproperties.com.au", style: "blue", open_in_new_tab: false },
      ],
      stats: [],
    },
    contact_info: {
      title: "Let's Talk Appraisal.",
      tagline: "Whether you're buying, selling, or investing — our advisors are ready to guide you through every step.",
      ...
      quote_text: '"Real estate is not just a transaction — it is the beginning of a life lived better."',
    ...
    contact_form: {
      ...
      property_type_options: ["Apartment", "Villa / Townhouse", "Penthouse", "Commercial", "Plot / Land"],
      budget_min: 500_000,
